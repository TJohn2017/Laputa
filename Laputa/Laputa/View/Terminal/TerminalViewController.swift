...
class TerminalViewController: UIViewController {
    ...
    // Starts terminal GUI for ssh connection
    func startConnection() -> SshTerminalView? {
        print ("2. startConnection() called")
        do {
            ...
            tv.feed(text: "Welcome to Claire's SwiftTerm App Mwahhahahah\n\n")
            return tv
...
// SwiftUITerminal is the object used to instaniate a terminal gui with a given ssh connection
